...
EXTERN_C const IID IID_INuiFusionColorReconstruction;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE DepthToDepthFloatFrame( 
            /* [in] */ const NUI_DEPTH_IMAGE_PIXEL *pDepthImageData,
...
#define INuiFusionColorReconstruction_ProcessFrame(This,pDepthFloatFrame,pColorFrame,maxAlignIterationCount,maxIntegrationWeight,maxColorIntegrationAngle,pWorldToCameraTransform)	\
    ( (This)->lpVtbl -> ProcessFrame(This,pDepthFloatFrame,pColorFrame,maxAlignIterationCount,maxIntegrationWeight,maxColorIntegrationAngle,pWorldToCameraTransform) ) 
